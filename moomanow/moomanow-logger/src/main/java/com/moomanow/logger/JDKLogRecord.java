...
public class JDKLogRecord extends LogRecord {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2019479154232577976L;
	   private static final String LOGGER_CLASS_NAME = Logger.class.getName();

	    private boolean resolved;
	    private final String loggerClassName;

	    JDKLogRecord(final Level level, final String msg) {
	        super(level, msg);
	        loggerClassName = LOGGER_CLASS_NAME;
	    }

	    JDKLogRecord(final Level level, final String msg, final String loggerClassName) {
	        super(level, msg);
