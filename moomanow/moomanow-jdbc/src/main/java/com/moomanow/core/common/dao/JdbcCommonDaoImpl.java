...
import com.moomanow.core.common.processhandler.UserBeanContext;
...
import com.moomanow.core.jdbc.constant.CommonMessageCode;
...
//	}
	...
	@Override
	public <T extends Object> T save(T target, boolean tableLang, String langCode) {
	...
	public KeyHolder saveKeyHolder(Object target, boolean tableLang, String langCode) {
		
		if(target instanceof EntityBean){
			UserBeanContext userBeanContext = CurrentBlockContextThread.getContext(UserBeanContext.class);
			EntityBean entityBean = (EntityBean) target;
			entityBean.setCreateDate(new Date());
			entityBean.setCreateUser(userBeanContext.getUserName());
...
//	}
	...
	@Override
	public <T extends Object> T saveOrUpdate(T target, boolean tableLang,String code,Long idLang) {
...
//	}
	...
	@Override
	public <T extends Object> T update(T target, boolean tableLang, String langCode,Long idLang){
		if(target instanceof EntityBean){
			UserBeanContext processContext = CurrentBlockContextThread.getContext(UserBeanContext.class);
			EntityBean entityBean = (EntityBean) target;
...
//	@Override
	...
	protected String genQueryStringByExample(Class<?> clazz,List<Criteria> criteriaList,PagingBean pagingBean,boolean like, String langCode3) {
		ClassMapper classMapper =JPAUtil.getClassMapper(clazz);
...
//			
	...
	protected Long getTotalRowByExample(Class<?> clazz,List<Criteria> criteriaList,boolean like,String LangCode) {
		ClassMapper classMapper =JPAUtil.getClassMapper(clazz);
		StringBuilder countQueryString = new StringBuilder();
		String tableName = classMapper.getTableName();
	...
	protected String genQueryWhereStringByECriteria(String tableName ,List<Criteria> criteriaList,boolean like) {
...
//		
	...
	@Override
	public <T> List<T> findByColumn(Class<T> clazz,List<Criteria> criterias, String langCode3){
		return findByColumn(clazz, criterias, null, false, langCode3);
	}
	@Override
	public <T> List<T> findByColumn(Class<T> clazz,List<Criteria> criterias,PagingBean pagingBean, String langCode3){
		return findByColumn(clazz, criterias, pagingBean, false, langCode3);
	}
	@Override
	public <T> List<T> findByColumn(Class<T> clazz,List<Criteria> criterias,PagingBean pagingBean){
	...
	public <T> T findByColumnOneRow(Class<T> clazz, List<Criteria> criteriaList,String langCode3,boolean like){
...
//							idlang =  checkLangBean(beanLang.getEngLang().getClass(), classMapper.getPropertyId().getColumnName(), idEng, entityBean.getStatus(), beanLang.getLangCode());
	...
	private boolean checkLangBean(Class<? extends Object> class1) {
	...
	private Long checkLangBean(Class<? extends Object> class1,String columnName, Object idEng, String status, String langCode) {
		ClassMapper classMapper = JPAUtil.getClassMapper(class1);
...
//				params.put("STATUS", status);
	...
	private Long checkLangBeanId(Class<? extends Object> class1,String columnName, Object idEng, Object idLang) {
		ClassMapper classMapper = JPAUtil.getClassMapper(class1);
		StringBuilder sb = new StringBuilder();
		sb.append("select ");
		sb.append(columnName);
	...
	@Override
	public <T> List<T> findByProperty(Class<T> clazz, String propertyName, Object value, PagingBean pagingBean)  {
//		if(pagingBean==null){
//			try{
//				List<Criteria> criteriaList = new LinkedList<Criteria>();
//				criteriaList.add(new Criteria(propertyName, value));
