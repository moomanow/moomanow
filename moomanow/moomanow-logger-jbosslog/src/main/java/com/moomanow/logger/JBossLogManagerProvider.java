...
final class JBossLogManagerProvider implements LoggerProvider {
    ...
    private static Logger doLegacyGetLogger(final String name) {
        final com.moomanow.logger.jboss.logmanager.Logger lmLogger = LogContext.getLogContext().getLogger("");
        ...
        final com.moomanow.logger.jboss.logmanager.Logger logger = org.jboss.logmanager.Logger.getLogger(name);
