package com.moomanow.web.struts;
...
import com.moomanow.core.common.processhandler.LocaleContext;
...
//    private static final Map<String, Map<String,Message>> messageCache  = new ConcurrentHashMap<String, Map<String,Message>>();
    ...
    private String findDBText(  String aTextName ,Locale locale, Object[] args) {
    ...
    private static Locale getLocal(Locale locale){
    	LocaleContext localeContext = CurrentBlockContextThread.getContext(LocaleContext.class);
    	Locale localeOut = localeContext.getLocale();
    	if(localeOut !=null){
    		return localeOut;
    	}else{
    		return locale;
    ...
    private String findDBText(  String aTextName ,Locale locale) {
