...
@StrutsTag(name="authen", tldBodyContent="JSP", tldTagClass="com.moomanow.core.common.web.struts.view.jsp.AuthenTag", description="Assigns a value to a variable in a specified scope")
