...
@StrutsTag(name="paging", tldBodyContent="JSP", tldTagClass="com.moomanow.core.common.web.struts.view.jsp.PagingTag", description="Assigns a value to a variable in a specified scope")
